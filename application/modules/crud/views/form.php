                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type='text' class="form-control" id="user_id" name="user_id" placeholder="" value="<?php echo set_value('user_id', (isset($post_data['user_id']) ? $post_data['user_id'] : '')); ?>" data-error=".user_iderror" maxlength="50"/>
                                <div class="user_iderror error_msg"><?php echo form_error('user_id', '<label class="danger">', '</label>'); ?></div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
    ...
    $("#formId").validate({
        ...
        submitHandler: function(form, event){
            ...
            function unique_mobile() {
                ...
                $.ajax({
                    type: "POST",
                    url: base_url+'<?php echo cruds_constants::unique_mobile_url; ?>',
                    async: false,
            ...
            function unique_email() {
                ...
                $.ajax({
                    type: "POST",
                    url: base_url+'<?php echo cruds_constants::unique_email_url; ?>',
                    async: false,
